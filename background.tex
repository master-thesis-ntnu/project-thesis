...
At the time of writing Elasticsearch is a popular open source search engines, which has proven the ability to scale up to petabytes of data [Field notes - ElasticSearch at petabyte scale on AWS][??].
